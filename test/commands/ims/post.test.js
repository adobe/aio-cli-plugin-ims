...
const TheCommand = require('../../../src/commands/ims/post')
const CallCommand = require('../../../src/ims-call-command')
...
test('exports and properties', () => {
  ...
  expect(TheCommand.prototype instanceof CallCommand).toBeTruthy()
...
test('call', async () => {
  const runResult = command.call(new ims.Ims())
